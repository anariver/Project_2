---
title: "Final Project: Equality and Tertiary Education"
subtitle: "An Analysis of U.S. Tertiary Education Institutions: Demographics, Tuition Costs and Salary Potential"
...
### **Initial Presentation: Racial Demographics at For-Profit and Not-For-Profit Educational Institutions**
...
### **Advancements in Analysis Since the Initial Presentation**
...
4. Are For-Profit Tuition Costs Higher than Non-Profit Tuition Costs?

5. How do diversity, tuition rates and salary rates at the top 20 schools compare to other schools?
...
## **Tidywork: Making Sense of our Data**
...
This facet wrap plot is consist with the barplot shown above, however the scale is not quite correct.  The scale problem was present for a number of our facet-wrap plots with enrollment percentage and will be discussed further below.  The census data will also be added in plots for the next question, since that was our primary focus for the project.

### Examination of 2-year and 4-year Program Racial and Ethnic Demographics
...
## **Question 4: Are For-Profit Tuition Costs Higher than Non-Profit Tuition Costs?**
...
### Creating a New Data Frame for Means/ Average Tuition  
```{r}
...
### Visualization of the Tution Rates at For-Profit and Non-Profit Schools
...
### Creating a New Data Set for Not Profits (In State Tuition)
...
### Graph of the Test 2 Data Set(Not Profits-In State Tuition) 
```{r}
plot1 <- test2%>%
...
## **Question 5: How do diversity, tuition rates and salary rates at the top 20 schools compare to other schools?**
...
### Graphing Diversity at Top Schools
...
### **Costs of Tuition, Salary Potential**
...
### **Tuition and Salary Potential at the Top Ranked Schools**
...
2. Comparing diversity in community colleges, four-year-institutions, and for-profit institutions.
